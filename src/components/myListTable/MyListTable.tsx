...
export default function MyListTable({ rows }: { rows: any[] }) {
                ...
                <TableBody>
                    {(rowsPerPage > 0
                        ...
                        <StyledTableRow key={row.title}>
                            ...
                            <StyledTableCell align="right"><Box
                                style={{ width: 40 }}
                                component="img"
                                alt={row.title}
                                src={`${IMG_BASE_URL}${row.poster_path}`}
                            /></StyledTableCell>
                            <StyledTableCell align="right">{row.vote_average}</StyledTableCell>
